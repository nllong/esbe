  ...
  module Scenario
    class ClassProjectMapper < BaselineMapper
      def create_osw(scenario, features, feature_names)
        ...
        OpenStudio::Extension.set_measure_argument(osw, 'ReduceVentilationByPercentage', '__SKIP__', true)
        OpenStudio::Extension.set_measure_argument(osw, 'ReduceVentilationByPercentage', 'design_spec_outdoor_air_reduction_percent', 30.0)
