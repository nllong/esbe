...
module URBANopt
  module Scenario
    class Hotel1Mapper < BaselineMapper
      def create_osw(scenario, features, feature_names)
        ...
        OpenStudio::Extension.set_measure_argument(osw, 'IncreaseInsulationRValueForExteriorWalls', 'r_value', 48.9505289702059)
        ...
        OpenStudio::Extension.set_measure_argument(osw, 'ReduceElectricEquipmentLoadsByPercentage', 'elecequip_power_reduction_percent', 34.6774803661031)

        OpenStudio::Extension.set_measure_argument(osw, 'ReduceLightingLoadsByPercentage', '__SKIP__', false)
        OpenStudio::Extension.set_measure_argument(osw, 'ReduceLightingLoadsByPercentage', 'lighting_power_reduction_percent', 29.3018385262864)

        OpenStudio::Extension.set_measure_argument(osw, 'ReduceSpaceInfiltrationByPercentage', '__SKIP__', false)
        OpenStudio::Extension.set_measure_argument(osw, 'ReduceSpaceInfiltrationByPercentage', 'space_infiltration_reduction_percent', 39.1562153065847)

        OpenStudio::Extension.set_measure_argument(osw, 'ReduceVentilationByPercentage', '__SKIP__', false)
        OpenStudio::Extension.set_measure_argument(osw, 'ReduceVentilationByPercentage', 'design_spec_outdoor_air_reduction_percent', 46.8551439626763)
